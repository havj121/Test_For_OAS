classdef OAS_DPM < handle
    %The OAS_DPM is to build the DEM and DPM, also update the DEM
    %according to the drivers' feedback and select the next query to the
    %simmodel.
     
    properties
        ID='OAS_DPM' %used for register in the oas_handlemanager
    ...
    % ================Constructor=============================
    methods
        function obj = OAS_DPM(DriverObj)
